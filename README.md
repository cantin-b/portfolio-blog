...
This blog uses a starter template for building a Next.js application that fetches data from a WordPress site using the WordPress REST API: [https://github.com/9d8dev/next-wp](https://github.com/9d8dev/next-wp)


## 🔌 WordPress REST API Cheatsheet

If you're building with WordPress as a headless CMS, here are the most common REST API endpoints and query parameters you’ll use when fetching content.
...
|-------------------|--------------------|----------------------------------------------------|
| Posts             | `/posts`           | All published posts                                |
| Single Post       | `/posts/:id`       | Get post by ID                                     |
| Pages             | `/pages`           | All pages                                          |
| Media             | `/media`           | All uploaded media                                 |
| Categories        | `/categories`      | All categories                                     |
| Tags              | `/tags`            | All tags                                           |
| Users (authors)   | `/users`           | All registered users/authors                       |
| Comments          | `/comments`        | All comments                                       |
| Post types        | `/types`           | All custom post types                              |
| Post statuses     | `/statuses`        | All post statuses (publish, draft, etc.)           |
| Settings          | `/settings`        | Site settings (requires authentication)            |
...
|--------------|-----------------------------------|--------------------------------------------------|
| `per_page`   | `?per_page=5`                     | Limit number of results                          |
| `page`       | `?page=2`                         | Paginate results                                 |
| `search`     | `?search=hello`                   | Search term                                      |
| `slug`       | `?slug=your-post-slug`            | Get post by slug                                 |
| `categories` | `?categories=3`                   | Filter posts by category ID                      |
| `tags`       | `?tags=5`                         | Filter posts by tag ID                           |
| `_embed`     | `?_embed`                         | Include embedded data (featured images, etc.)    |
...
You can combine endpoints and filters like:

---

## Template's official documentation
